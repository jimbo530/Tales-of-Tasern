  ...
  return (
    <div className="flex flex-col items-center gap-4 w-full max-w-3xl mx-auto">
      ...
      <div className="w-full rounded-xl p-4 battle-arena">
        <p className="text-center text-xs tracking-widest uppercase mb-3" style={{ color: 'rgba(220,38,38,0.5)' }}>Enemies</p>
        <div className="flex justify-center gap-4 flex-wrap">
          {enemies.map((e, i) => <UnitPortrait key={i} unit={e} />)}
        </div>
      </div>
      ...
      <div className="w-full rounded-xl p-4" style={{ background: 'rgba(201,168,76,0.05)', border: '1px solid rgba(201,168,76,0.2)' }}>
        <p className="text-center text-xs tracking-widest uppercase mb-3" style={{ color: 'rgba(201,168,76,0.5)' }}>Your Party</p>
        <div className="flex justify-center gap-4 flex-wrap">
          {players.map((p, i) => <UnitPortrait key={i} unit={p} />)}
        </div>
      </div>
